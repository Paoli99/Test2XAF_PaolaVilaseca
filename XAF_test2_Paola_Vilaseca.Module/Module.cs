...
namespace XAF_test2_Paola_Vilaseca.Module;

// For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.ModuleBase.
public sealed class XAF_test2_Paola_VilasecaModule : ModuleBase {
    public XAF_test2_Paola_VilasecaModule() {
		// 
		// XAF_test2_Paola_VilasecaModule
		// 
