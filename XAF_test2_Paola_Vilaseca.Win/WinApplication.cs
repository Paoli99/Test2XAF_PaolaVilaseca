...
namespace XAF_test2_Paola_Vilaseca.Win;

// For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.Win.WinApplication._members
public class XAF_test2_Paola_VilasecaWindowsFormsApplication : WinApplication {
    public XAF_test2_Paola_VilasecaWindowsFormsApplication() {
		SplashScreen = new DXSplashScreen(typeof(XafSplashScreen), new DefaultOverlayFormOptions());
        ApplicationName = "XAF_test2_Paola_Vilaseca";
        CheckCompatibilityType = DevExpress.ExpressApp.CheckCompatibilityType.DatabaseSchema;
        UseOldTemplates = false;
        DatabaseVersionMismatch += XAF_test2_Paola_VilasecaWindowsFormsApplication_DatabaseVersionMismatch;
        CustomizeLanguagesList += XAF_test2_Paola_VilasecaWindowsFormsApplication_CustomizeLanguagesList;
    }
    private void XAF_test2_Paola_VilasecaWindowsFormsApplication_CustomizeLanguagesList(object sender, CustomizeLanguagesListEventArgs e) {
        string userLanguageName = System.Threading.Thread.CurrentThread.CurrentUICulture.Name;
        if(userLanguageName != "en-US" && e.Languages.IndexOf(userLanguageName) == -1) {
            e.Languages.Add(userLanguageName);
        }
    }
    private void XAF_test2_Paola_VilasecaWindowsFormsApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
